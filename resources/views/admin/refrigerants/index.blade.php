...
@section('header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Refrigerantes</li>
    </ol>
@stop
    ...
    <div class="box box-primary">
        <div class="box-header">
            ...
            <button class="btn btn-primary pull-right" data-toggle="modal" data-target="#exampleModal">
                <i class="fa fa-plus"></i> Crear nuevo refrigerante
            </button>
        </div>
        <!-- /.box-header -->
        <div class="box-body table-responsive">
            <table id="refrigerants-table" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        <th>Id</th>
                        <th>Nombre</th>
                ...
                <tbody>
                    @foreach($refrigerants as $refrigerant)
                        <tr> 
                            ...
                            <td>
                                <a href="{{ route('admin.refrigerants.edit', $refrigerant) }}" 
                                    class="btn btn-info"
